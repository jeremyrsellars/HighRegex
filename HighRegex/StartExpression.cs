...
namespace HighRegex
{
   ...
   public class StartExpression<T> : IExpression<T>, IMatchProvider<T>, ILookBackMatchProvider
   {
      /// <summary>
      ...
      public MatchLength IsMatchAt(IExpressionItemSource<T> input, int index)
      {
         ...
         return MatchLength.EmptyMatch(index == 0);
      }
      ...
      /// <remarks>
      /// StartExpression will yield 0 or 1 result.
