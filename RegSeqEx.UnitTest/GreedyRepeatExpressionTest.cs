...
{
   [TestClass]
   public class GreedyRepeatExpressionTest
   {
      ...
      //
      // Constructor GreedyRepeatExpressionTest (IExpression<char> [])
      //
      [TestMethod]
      ...
      //
      // Constructor GreedyRepeatExpressionTest (IExpression<char> [], exact)
      //
      [TestMethod]
      [ExpectedException (typeof(ArgumentNullException))]
      public void ExactConstructorThrowArgumentNullExceptionForNullArray()
      {
         var expression = new GreedyRepeatExpression<char> ((IExpression<char>) null, 2);
      }
      ...
      //
      // Constructor GreedyRepeatExpressionTest (IExpression<char> [], min, max)
      //
      [TestMethod]
      [ExpectedException (typeof(ArgumentNullException))]
      ...
      {
         var expression = new GreedyRepeatExpression<char> (m_any, 1, -1);
      }
      ...
      public void RangeConstructorSucceeds()
      {
         int min = 2;
         int max = min;
         var expression = new GreedyRepeatExpression<char> (m_A, min, max);
         Assert.AreEqual (min, expression.Minimum, "Minimum");
         Assert.AreEqual (max, expression.Maximum, "Maximum");
      }
      ...
      [TestMethod]
      public void GetMatchesOf_AAorABBB_0_4_ForAAABBB()
      {
         int index = 0;
         GreedyRepeatExpression<char> expression = 
            new GreedyRepeatExpression<char> (
      ...
      {
         var expression = new GreedyRepeatExpression<char> (LookBackNotSupported);
      ...
      {
         var expression = new GreedyRepeatExpression<char> (AnyLength, 2);
      ...
      public void GetPossibleMatchLengths_For1_1 ()
      {
         ...
         var expression = new GreedyRepeatExpression<char> (MatchLength1,2);
         expression.AssertPossibleMatchLengths (expected);
      }
